...
data class InvokeDynamicInsn(val name: String, val desc: String, val bsm: Handle, val bsmArgs: List<Any>): Instruction()
data class JumpInsn(val opcode: Int, val label: LabelName): Instruction()
data class LdcInsn(val cst: Any): Instruction()
